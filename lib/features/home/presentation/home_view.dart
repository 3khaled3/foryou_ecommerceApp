    ...
    return FutureBuilder<void>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final categoriesProductmap = BlocProvider.of<ApiCubit>(context).categoriesProduct;
            ...
            return Scaffold(
              ...
              body: SingleChildScrollView(
                ...
                child: Column(children: [
                  HomeCategory(categoriesProductmap:categoriesProductmap,categorieslist:categorieslist ),
                  SizedBox(
